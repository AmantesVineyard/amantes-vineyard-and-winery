  ...
  return (
    <>
      <SEO 
        ...
        canonical="/about"
        keywords="about Amantes Vineyard, Persian Jewish winemaking, kosher winery history, Temecula vineyard story, Nassir family winery"
      />
      ...
      <div className="min-h-screen bg-wine-cream">
        ...
        <main id="main-content">
          <article className="py-20 px-4 pb-32 relative">
            ...
            <div className="container mx-auto max-w-4xl">
              ...
              <section className="mb-16" aria-labelledby="legacy-heading">
                <h1 id="legacy-heading" className="text-4xl md:text-5xl font-serif text-wine-deep mb-8">
