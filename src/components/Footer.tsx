  ...
  return (
    <footer className="relative">
      ...
      <div className="bg-wine-cream py-16 pb-32 relative">
        ...
        {/* Wavy Shape Transition - using object to preserve internal styles */}
        <div className="absolute bottom-0 left-0 right-0 w-full pointer-events-none" style={{ height: '103px' }}>
          <object 
            data={footerShape}
            type="image/svg+xml"
